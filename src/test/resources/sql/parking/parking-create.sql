...
insert into Car_Space (id, code, status) values (400, 'A-04', 'FREE');
insert into Car_Space (id, code, status) values (500, 'A-05', 'FREE');
...
insert into Clients_has_Carspaces (receipt_code, license_plate, car_brand, car_model, car_color, entry_date, id_client, id_carspace)
    values ('20230313-101300', 'UJB2S76', 'FIAT', 'PALIO', 'GREEN', '2023-03-13 10:15:00', 22, 100);
insert into Clients_has_Carspaces (receipt_code, license_plate, car_brand, car_model, car_color, entry_date, id_client, id_carspace)
    values ('20230314-101400', 'HVJ4K87', 'FIAT', 'SIENA', 'WHITE', '2023-03-14 10:15:00', 21, 200);
insert into Clients_has_Carspaces (receipt_code, license_plate, car_brand, car_model, car_color, entry_date, id_client, id_carspace)
    values ('20230315-101500', 'AOZ2O72', 'FIAT', 'PALIO', 'GREEN', '2023-03-14 10:15:00', 22, 300);